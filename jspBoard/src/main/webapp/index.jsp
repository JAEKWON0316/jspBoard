...
<%@ page import="java.sql.Connection , java.util.ArrayList, java.sql.Timestamp, jspBoard.service.Paging, jspBoard.dao.*, jspBoard.dto.BDto, java.text.SimpleDateFormat, java.text.NumberFormat"  %>  <!--  -->  
                ...
                <div class="listbox">
                    ...
                    <div class="d-flex justify-content-between py-4 btn-box">
                        ...
                        <ul class="paging">
                            ...
                            %>
                               <a href="?cpg=<%=myPage.getStartPage()%>"><i class="ri-arrow-left-s-line"></i></a>
                            <% }else{ %>
                                <a href="?cpg=<%=myPage.getStartPage()-1%>"><i class="ri-arrow-left-s-line"></i></a>
                            <% } %>
                            </li>
                            ...
                            %>
                               <a href="?cpg=<%=myPage.getEndPage()%>"><i class="ri-arrow-right-s-line"></i></a>
                            <% }else{ %>
                                <a href="?cpg=<%=myPage.getEndPage() + 1%>"><i class="ri-arrow-right-s-line"></i></a>
                            <% } %>
                            </li>
                            <li>
                                <a href="?cpg=<%=myPage.getTotalPages()%>"><i class="ri-arrow-right-double-line"></i></a>
                            </li>
                        </ul>
                            <div>
                                <a href="/jspBoard" class="btn btn-dark">목록</a>
